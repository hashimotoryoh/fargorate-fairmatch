...
アップデートやプレスリリースなどのニュースも、同じくNuxt Contentで管理する。プライバシーポリシー等が1文書1ページなのに対し、ニュースは複数記事を持つため、`content/<言語>/news/<スラッグ>.md` に置き、`/news` の一覧と `/news/<スラッグ>` の詳細に分けて表示する。
